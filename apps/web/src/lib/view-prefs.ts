...
/** The humane groups the 24 rules fall into, by WHY a user would hide them (design §3). UI-only. */
 ...
 *  a key for EVERY member of core's `Rule` union: adding a 25th rule to core fails `pnpm typecheck` here
