...
/** The humane groups the 26 rules fall into, by WHY a user would hide them (design §3). UI-only. */
 ...
 *  a key for EVERY member of core's `Rule` union: adding a 27th rule to core fails `pnpm typecheck` here
