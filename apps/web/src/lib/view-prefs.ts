...
/** The humane groups the 29 rules fall into, by WHY a user would hide them (design §3). UI-only. */
 ...
 *  a key for EVERY member of core's `Rule` union: adding a 30th rule to core fails `pnpm typecheck` here
...
export const RULE_GROUP: Record<Rule, RuleGroupId> = {
  ...
  'trim-margin': 'packing',
  'excessive-gutter': 'packing',
  'spine-unreferenced-regions': 'packing',
