...
/** The humane groups the 27 rules fall into, by WHY a user would hide them (design §3). UI-only. */
 ...
 *  a key for EVERY member of core's `Rule` union: adding a 28th rule to core fails `pnpm typecheck` here
