...
// the first valuable answer is "сколько веса срезать и с чего начать"). apps/web has no React harness (vitest
// env=node), so the load-bearing ranking lives here and is Node-unit-tested; BiggestWins.tsx is a thin renderer.
//
