...
*Обновлено 2026-07-03 (раунд 29 + UX-раунды 1-4 + сборщик ассетов R1-5 + единый конфиг/страница настроек + профиль-осознанные форматы упаковки + спрайтшит-в-первую-очередь/честное сворачивание + формат-сиблинги + лендинг). Ветка `feat/asset-pipeline` (= локальный `main`), ~91 коммит поверх `origin/main`, всё зелёное. Деплой (GH Pages) ждёт пользовательского `git push origin main`; живые бэкенд-операции требуют бинарей toktx/pngquant/vips в задеплоенном сайдкаре.*
